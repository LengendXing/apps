        ...
        <div class="bg-card rounded-lg border border-border overflow-hidden">
          <table class="w-full text-sm">
            <thead class="border-b border-border">
              <tr>
                <th class="px-4 py-3 text-left font-medium text-muted-foreground">{{ t('upload.file') }}</th>
                ...
                <th class="px-4 py-3 text-right font-medium text-muted-foreground">{{ t('upload.action') }}</th>
              </tr>
            </thead>
            <tbody>
